...
def enviar_whatsapp_cloud(texto, phone_destino):
    ...
    OJO: fuera de la ventana de 24h (es decir, si el usuario no le escribio
    al numero recientemente), Meta solo permite PLANTILLAS aprobadas, no texto
    libre. Esta funcion intenta texto libre; si Meta lo rechaza por la ventana,
    lo deja registrado en el log. Para algo 100% confiable se necesita una
    plantilla aprobada (lo vemos como siguiente paso).
    """
